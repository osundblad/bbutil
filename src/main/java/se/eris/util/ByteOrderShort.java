...
public class ByteOrderShort extends ByteOrderBase {
    ...
    public static final ByteOrderShort BIG_ENDIAN = new ByteOrderShort("BigEndian", new int[]{8, 0});
    public static final ByteOrderShort LITTLE_ENDIAN = new ByteOrderShort("LittleEndian", new int[]{0, 8});
